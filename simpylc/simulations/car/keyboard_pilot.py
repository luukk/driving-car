...
class KeyboardPilot:
    ...
    def input (self):
        ...
        self.targetVelocityStep = sp.world.physics.targetVelocity
        self.steeringAngleStep = sp.world.physics.steeringAngle
    ...
    def output (self):
        sp.world.physics.targetVelocity.set (self.targetVelocityStep)
        sp.world.physics.steeringAngle.set (self.steeringAngleStep)
